    ...
    <header class="header">
        ...
        <div class="main-header">
            <div class="left-section">
                <a href="user_login.php"><img src="images/lcLogo.png" alt="LG Logo" class="logo-small" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';"></a>
            ...
            <div class="center-section">
                <a href="user_login.php"><img src="images/homepage_title.png" alt="Lalal & Co" class="logo-main" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';"></a>
                ...
                <div class="icon cart-icon">
                    <svg viewBox="0 0 24 24">
                        <path d="M7 18c-1.1 0-1.99.9-1.99 
                                 ...
                                 2v2h2l3.6 7.59-1.35 
                                 2.45c-.16.28-.25.61-.25.96 0 1.1.9 
                                 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 
